...
class ControleRede():
    ...
    def adicionar(self):
        ...
        if self.buscar_por_codigo(dados_rede["codigo"]):
            ...
            self.__redes.append(Rede(dados_rede["nome"], dados_rede["codigo"], dados_rede["localizacao_rede"]))
    ...
    def remover(self):
        ...
        if not rede_existe:
            raise Exception(f"Rede de código [{codigo}] não foi encontrada para ser removida.")
    ...
    def listar(self):
        return map(lambda rede : {"nome": rede.nome, "localizacao_rede": rede.localizacao_rede, "codigo": rede.codigo}, self.__redes)
    ...
    def alterar(self):
        ...
        for rede in self.__redes:
            if rede.codigo == dados_rede["codigo"]:
                ...
                self.__redes[rede.codigo]["localizacao_rede"] = dados_rede["localizacao_rede"]
